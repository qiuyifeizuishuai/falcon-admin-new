  ...
  <div>
    ...
    >
      ...
      >
        ...
        <div class="fr">
          ...
          <el-form-item>
            ...
            <el-button type="success" icon="el-icon-plus" @click="jump('onlineTestAdd')">认定考试</el-button>
        </div>
      </el-form>
      ...
      <el-table slot="list" :data="demoList" stripe border>
        ...
        <el-table-column prop="paperName" align="center" label="考试名称">
        ...
        <el-table-column prop="created_at" align="center" label="操作" width="300">
          <template slot-scope="scope">
            <div class="box">
              <span class="link falcon-primary" @click="jump('onlineTestAdd', scope.row.uuid)">编辑/查看</span>
              <span
                class="link falcon-primary"
                @click="jump('registerStudent', scope.row.uuid)"
              >报名学员</span>
              <span class="link falcon-primary" @click="jump('testScoring', scope.row.uuid)">考题及阅卷</span>
              <el-popconfirm
              ...
              >
                ...
                >{{scope.row.isOffline ? '上线' : '下线'}}</span>
              </el-popconfirm>
            </div>
          </template>
        </el-table-column>
...
export default {
  ...
  created() {
    this.$emit('getMeteData', this.$Bre.breadCrumbs([0, 6, 62]));
