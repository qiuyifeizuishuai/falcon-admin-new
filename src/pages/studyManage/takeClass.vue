        ...
        >
            ...
            >
                ...
                <el-button
                    ...
                    type="success"
                    icon="el-icon-plus"
                    @click="$router.push({name:'addCurriculum',query:{isAdded:'use',type:'elective'}})"
                >新增课程
                </el-button>
...
<!--                </el-table-column>-->
              ...
              <span
                  class="span"
                  @click="$router.push({name:'addCurriculum',query:{uuid:scope.row.uuid,isAdded:'see',type:'elective'}})"
              >编辑/查看</span>
                            <em class="emClass"></em>
                            <span
                                class="span"
...
<script>
    ...
    export default {
        ...
        created() {
            this.$emit('getMeteData', this.$Bre.breadCrumbs([0, 3, 36]));
        },
        mounted() {
