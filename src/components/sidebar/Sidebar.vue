<template>
    <div>
        <!-- begin #sidebar -->
        <div class="sidebar" id="sidebar" v-bind:class="{ 'sidebar-transparent': pageOptions.pageSidebarTransparent }">
            ...
            <vue-custom-scrollbar class="height-full">
                ...
                <sidebar-nav ref="sidebarNav"
                             ...
                             v-on:showFloatSubmenu="handleShowFloatSubmenu"></sidebar-nav>
                <!-- end sidebar nav -->
        ...
        <div @mouseleave="handleHideFloatSubmenu"
